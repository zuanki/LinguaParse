...
class JPStemmer:
    def __init__(self):
        ...
        self.nadjend = [u"です", u"だ", u"でした", u"だった", u"ではありません",
                        u"ではない", u"ではありませんでした", u"ではなかった", u"じゃない"]
        self.iadjend = [u"くなかった", u"かった", u"くない"]
        self.wordlist = [u"わ", u"か", u"が", u"さ", u"ざ", u"た",
                         u"だ", u"な", u"ま", u"は", u"ば", u"ぱ", u"ら", u"や"]
        self.ilist = [u"い", u"き", u"ぎ", u"し", u"じ", u"ち",
                      u"ぢ", u"に", u"み", u"ひ", u"び", u"ぴ", u"り"]
        self.ulist = [u"う", u"く", u"ぐ", u"す", u"ず", u"つ",
                      u"づ", u"ぬ", u"む", u"ふ", u"ぶ", u"ぷ", u"る", u"ゆ"]
        self.elist = [u"え", u"け", u"げ", u"せ", u"ぜ", u"て",
                      u"で", u"ね", u"め", u"へ", u"べ", u"ぺ", u"れ"]
        self.olist = [u"お", u"こ", u"ご", u"そ", u"ぞ", u"と",
                      u"ど", u"の", u"も", u"ほ", u"ぼ", u"ぽ", u"ろ", u"よ"]
        self.tte = [u"って", u"った", u"んで", u"んだ",
                    u"いて", u"いた", u"きて", u"いで", u"いだ", u"ぎで"]
            ...
            if self.wordg[0] == "two" and self.word[-1] not in self.ulist or self.word[-1] != u"る":
                ...
                if self.word[len(self.original) - (len(self.ending) + 1)] in self.wordlist:
                    ...
                    self.word = self.word[:-1] + \
                        self.ulist[self.wordlist.index(self.word[-1])]
                ...
                # This does the same as the previous if statement, but for "i" characters.
                    ...
                    self.word = self.word[:-1] + \
                        self.ulist[self.ilist.index(self.word[-1])]
